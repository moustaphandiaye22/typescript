...
let MyClass = (() => {
    let _classDecorators = [Log("Classe")];
...
let MyotherClass = (() => {
    ...
    let _maMethode_decorators;
    return _a = class MyotherClass {
            maMethode(param1, param2) {
        ...
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _maMethode_decorators = [Log("Méthode")];
            __esDecorate(_a, null, _maMethode_decorators, { kind: "method", name: "maMethode", static: false, private: false, access: { has: obj => "maMethode" in obj, get: obj => obj.maMethode }, metadata: _metadata }, null, _instanceExtraInitializers);
