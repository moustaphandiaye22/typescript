...
let Production = (() => {
    ...
    return _a = class Production {
            constructor() {
                this.nom = __runInitializers(this, _nom_initializers, "Tableau");
                __runInitializers(this, _nom_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _nom_decorators = [decorateursDePropriete];
